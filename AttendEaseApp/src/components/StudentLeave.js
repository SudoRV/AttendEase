    ...
    <PullToRefresh onRefresh={loadLeaves}>
      <View className="flex-1">
        ...
        >
          ...
          {/* LEAVE SUMMARY */}
          <View className="bg-white rounded-3xl p-5 elevation-md border border-slate-100 mb-6">
          ...
          {/* LATEST STATUS */}
          <View className="bg-white rounded-3xl p-5 elevation-sm border border-slate-100 mb-6">
            ...
            {leaveHistory?.length ? (
              <>
                ...
                <Modal transparent={true} visible={latestLeaveModal} animationType="slide" transparent={true}>
                  <View className="flex-1 bg-black/40">
                    <View className="mt-auto min-h-60 bg-white p-5 rounded-t-[30px]">
                      <View className="flex-row justify-between">
                        <Text className="text-2xl font-semibold">Latest application details</Text>
          ...
          {/* FORM */}
          <View className="bg-white rounded-3xl p-6 elevation-sm border border-slate-100">
            ...
            <TouchableOpacity
              onPress={submitLeave}
              disabled={loading}
              className={`mt-6 py-4 rounded-2xl elevation-sm ${loading ? "bg-indigo-300" : "bg-indigo-600"
                }`}
            >
